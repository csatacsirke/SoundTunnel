...
// SoundTunnel.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CSoundTunnelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSoundTunnelApp construction

CSoundTunnelApp::CSoundTunnelApp()
{
...
// The one and only CSoundTunnelApp object

CSoundTunnelApp theApp;


// CSoundTunnelApp initialization

BOOL CSoundTunnelApp::InitInstance()
{
